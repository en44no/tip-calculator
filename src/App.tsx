      ...
      <div style={{ 'width': '33%', 'background': '#ffffff' }} className='p-10 flex flex-col gap-3 rounded-lg shadow-xl'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <div className='relative'>
            ...
            <input id='quantity' type='number' min='0' className='border border-blue-500 rounded-lg h-8 pl-8 pr-2 w-full' value={quantity} onChange={(e) => setQuantity(parseInt(e.target.value))} />
          </div>
        </div>
        <div className='flex flex-col gap-1'>
          ...
          <div className='relative'>
            ...
            <input id='percentage' type='number' min='0' className='border border-blue-500 rounded-lg h-8 pl-8 pr-2 w-full' value={tipPercentage} onChange={(e) => setTipPercentage(parseInt(e.target.value))} />
          </div>
        </div>
        <div className='flex flex-col gap-1'>
          <label htmlFor='percentage' className='block text-md font-medium text-gray-700'>Cantidad de personas</label>
          <div className='relative border border-blue-500 rounded-lg p-1'>
            <div className="absolute inset-y-0 left-0 pl-1 flex items-center pointer-events-none">
              <span className="font-bold text-gray-400 text-md"> <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
